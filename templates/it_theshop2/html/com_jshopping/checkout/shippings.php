...
<?php foreach($this->shipping_methods as $shipping){?>
  <tr>
    <td style = "padding-top:5px; padding-bottom:5px">
       ...
       <label style="padding: 8px 0 0;" for = "shipping_method_<?php print $shipping->sh_pr_method_id ?>">
       
       <input style="margin:-3px 2px 0 0;" type = "radio" name = "sh_pr_method_id" id = "shipping_method_<?php print $shipping->sh_pr_method_id?>" value="<?php print $shipping->sh_pr_method_id ?>" <?php if ($shipping->sh_pr_method_id==$this->active_shipping){ ?>checked = "checked"<?php } ?> />
     <?php
      if ($shipping->image){
