...
@media (max-width: 767px) {
	...
	table.jshop.cart td:nth-of-type(4):before { content: "<?php print _JSHOP_NUMBER?>"; }
	table.jshop.cart td:nth-of-type(5):before { content: "<?php print _JSHOP_PRICE_TOTAL?>"; }
	table.jshop.cart td:nth-of-type(6):before { content: "<?php print _JSHOP_REMOVE?>"; }
...
<table class="jshop" style="margin-top:10px">
  <tr id = "checkout">
    ...
    <?php if ($countprod>0){?>
       <a href = "<?php print $this->href_checkout ?> " class="button button_checkout">
...
<table class="jshop">
  <tr>
    <td>
      ...
      <input type = "submit" class = "button" id="button_activate"  value = "<?php print _JSHOP_RABATT_ACTIVE ?>" />
    </td>
  </tr>
</table>
</form>
