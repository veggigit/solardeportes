    ...
    <ul id="ice-switcher">
        <li class="style1"><a
                href="templates/<?php echo $this->template;?>/css/styles/style-switcher.php?templatestyle=style1"><span>Style
                    1</span></a></li>
        <li class="style2"><a
                href="templates/<?php echo $this->template;?>/css/styles/style-switcher.php?templatestyle=style2"><span>Style
                    2</span></a></li>
        <li class="style3"><a
                href="templates/<?php echo $this->template;?>/css/styles/style-switcher.php?templatestyle=style3"><span>Style
                    3</span></a></li>
        <li class="style4"><a
                href="templates/<?php echo $this->template;?>/css/styles/style-switcher.php?templatestyle=style4"><span>Style
                    4</span></a></li>
        <li class="style5"><a
                href="templates/<?php echo $this->template;?>/css/styles/style-switcher.php?templatestyle=style5"><span>Style
                    5</span></a></li>
        <li class="style6"><a
                href="templates/<?php echo $this->template;?>/css/styles/style-switcher.php?templatestyle=style6"><span>Style
                    6</span></a></li>
    </ul>
    <?php } ?>
                ...
                <div id="social_icons">
                    <ul>
                        ...
                        <li class="social_facebook">
                            <a target="_blank" rel="tooltip" data-placement="top"
                                title="Like <?php echo $social_fb_user; ?> on Facebook"
                                href="http://www.facebook.com/<?php echo $social_fb_user; ?>"><span>Facebook</span></a>
                        </li>
                        <?php } ?>

                        <?php if($this->params->get('social_icon_tw')) { ?>
                        <li class="social_twitter">
                            <a target="_blank" rel="tooltip" data-placement="top" title="Follow us on Twitter"
                                href="http://www.twitter.com/<?php echo $social_tw_user; ?>"><span>Twitter</span></a>
                        </li>
                        <?php } ?>

                        <?php if($this->params->get('social_icon_yt')) { ?>
                        <li class="social_youtube">
                            <a target="_blank" rel="tooltip" data-placement="top" title="Subscribe on YouTube"
                                href="http://www.youtube.com/<?php echo $social_yt_user; ?>"><span>Youtube</span></a>
                        </li>
                        <?php } ?>
